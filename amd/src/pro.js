...
define(['jquery', 'core/log', 'core/config'], function($, log, cfg) {
    ...
    var versionnedresourcepro = {

        component: 'mod_versionnedresource',
        shortcomponent: 'versionnedresource',
        componentpath: 'mod/versionnedresource',

        init: function() {

            var licensekeyid = '#id_s_' + versionnedresourcepro.component + '_licensekey';
            $(licensekeyid).bind('change', this.check_product_key);
            $(licensekeyid).trigger('change');
            log.debug('AMD Pro js initialized for ' + versionnedresourcepro.component + ' system');
        },
        ...
        check_product_key: function() {
            ...
            var calculated = versionnedresourcepro.checksum(payload);
            ...
            if (crc === calculated) {
                var url = cfg.wwwroot + '/' + versionnedresourcepro.componentpath + '/pro/ajax/services.php?';
                url += 'what=license';
                url += '&service=check';
                url += '&customerkey=' + that.val();
                url += '&provider=' + $('#id_s_' + versionnedresourcepro.component + '_licenseprovider').val();
