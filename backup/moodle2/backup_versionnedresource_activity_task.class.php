...
require_once($CFG->dirroot . '/mod/versionnedresource/backup/moodle2/backup_versionnedresource_settingslib.php'); // Because it exists (must)
require_once($CFG->dirroot . '/mod/versionnedresource/backup/moodle2/backup_versionnedresource_stepslib.php'); // Because it exists (must)
...
class backup_versionnedresource_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new backup_versionnedresource_activity_structure_step('versionnedresource_structure', 'versionnedresource.xml'));
    }
